    ...
    <main class="flex flex-auto flex-col main">
        ...
        <form action="?id_pegawai=<?= $id_pegawai_to_update ?>" class="my-5 p-5 pb-2 rounded-md" method="post">
            ...
            <div class="flex justify-end">
                ...
                <button class="active-scale bg-blue-900 block px-3 py-2 mx-1 my-2 text-white rounded-md" name="update_pegawai_password" title="Simpan/Update Sandi" type="submit">

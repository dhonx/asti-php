...
<body class="flex font-sans min-h-screen overflow-hidden text-sm">
    ...
    <main class="flex flex-auto flex-col main">
        ...
        <div class="flex my-4">
            <a class="active-scale bg-blue-900 font-bold mr-2 px-3 py-2 rounded-md text-white" href="create" role="button" title="Tambah Pemasok">
                <span class="mdi align-middle mdi-plus"></span>
                Tambah
            </a>
            <form class="flex ml-auto relative" method="get">
                <input class="bg-gray-200 px-2 mx-2 rounded-md" placeholder="Cari..." name="keyword" title="Cari data pemasok" type="text" value="<?= $keyword ?>">

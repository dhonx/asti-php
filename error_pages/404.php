...
<body class="bg-purple">
    <div class="stars">
        <div class="central-body">
            <div style="position: relative; z-index:91">
                <div style="color:#fff;font-size: 10rem; font-weight:bold;z-index:4">404</div>
                <div style="color: #fff;font-size: 2rem;">Sepertinya kamu tersesat di luar angkasa...</div>
            </div>

...
<header class="bg-blue-500 flex pl-2 pr-5 md:items-center text-white">
    <h3 class="brand font-bold ml-auto lg:ml-0 text-3xl"><a href="<?php echo BASE_PATH ?>">ASTI</a></h3>
    <div class="cursor-pointer lg:hidden ml-auto md:flex self-center sm:flex xs:flex" id="mobile-menu">
        <img src="<?php echo BASE_PATH ?>/img/open-menu.svg" alt="">
    </div>
</header>
